    ...
    datatable = $('#tblDatos').DataTable({
        ...
        "columns": [
            ...
            { "data": "marca.nombre" },
            {
                ...
                {
                    var dolar = data.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
                    return dolar;
                }
            ...
            {
                /*Acceso a los Botones  VIDEO 35 caso bodega*/
                "data": "id",
                "render": function (data) {
                    return `
                        <div>
...
function Delete(url) {    /* VIDEO 41*/

    swal({
        title: "Esta Ud. seguro de eliminar el Producto",
